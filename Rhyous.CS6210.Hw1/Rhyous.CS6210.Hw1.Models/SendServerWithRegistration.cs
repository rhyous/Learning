...
{
    public class SendServerWithRegistration : RegistrationClient, IServer<ZFrame>, ISendAsync, IDisposable
    {
        ...
        public SendServerWithRegistration(string name, string endpoint, string nsEndpoint, ILogger logger) : base(nsEndpoint, new SystemRegistration(name, endpoint), true, logger)
        {
            Name = name;
            Endpoint = endpoint;
        }
